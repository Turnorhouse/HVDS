function HVDS_Staging
 {
  ...
  New-ItemProperty HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce -Name 'Domain_Bind' -Value 'powershell.exe . C:\HVDS\postconfig\dirsync.ps1;Domain_Bind'
